...
Source: `papers/DeepSeek_V4.pdf`

Extracted with `pdftotext -layout`; formulas and tables are best-effort from the PDF text layer. For exact visual layout, see `rendered/pages/`.
...
---
    ...
    are available at https://huggingface.co/collections/deepseek-ai/deepseek-v4.
                            ...
                            DeepSeek-V4-Pro-Max                        Claude-Opus-4.6-Max                     GPT-5.4-xHigh             Gemini-3.1-Pro-High                                                          DeepSeek-V4-Flash
                                                                                                                                                                                                        0.8
             100                                                                                                                                                                                                                           3.7× lower
                                                                        90.2                     32063168
                                                                           85.9
...
Accuracy / Pass@1 (%)
                  ...
                  60 57.9
                                                                                                                                                                 54.6
                                                                                                                                                      51.8                                              0.0
                                                                                                                                                         47.2           48.8                                      0    256      512        768    1024
                              46.2 45.3                         44.4                                                                                                                                                     Token Position (K)
                  40                             37.740.039.8
                                                                                                                                                                                                          50
                                                                                                                                                                                                                      DeepSeek-V3.2
                  ...
                  20                                                                                                                                                                                      40          DeepSeek-V4-Pro
                                                                                                                                                                                                                      DeepSeek-V4-Flash
                                                                                                                                                                                                          30
                        0                                                                                                                                                                                                               9.5× smaller
                            SimpleQA                  HLE                   Apex Codeforces SWE                                Terminal                Toolathlon
                             Verified                (Pass@1)             Shortlist (Rating) Verified                          Bench 2.0                     (Pass@1)                                     20                          13.7× smaller
                              (Pass@1)                                         (Pass@1)                          (Resolved)          (Acc)


                                                 Knowledge & Reasoning                                                   Agentic Capabilities                                                             10
...
where 𝑑 is the hidden size of the actual layer input. Let 𝑋𝑙 = [x𝑙,1 ; . . . ; x𝑙,𝑛hc ] 𝑇 ∈ R𝑛hc × 𝑑 be the
residual state before the 𝑙-th layer. HC introduces three linear mappings: an input mapping
𝐴𝑙 ∈ R1× 𝑛hc , a residual transformation 𝐵𝑙 ∈ R𝑛hc × 𝑛hc , and an output mapping 𝐶 𝑙 ∈ R𝑛hc ×1 . The
update of the residual state is then formulated as:

                                        𝑋𝑙+1 = 𝐵𝑙 𝑋𝑙 + 𝐶 𝑙 F𝑙 ( 𝐴𝑙 𝑋𝑙 ),                               (1)
...
M, and thus enhance the stability of signal propagation across layers:
                         𝐵𝑙 ∈ M ≔ { 𝑀 ∈ R𝑛 × 𝑛 | 𝑀 1𝑛 = 1𝑛 , 1𝑇𝑛 𝑀 = 1𝑇𝑛 , 𝑀 ⩾ 0}.                          (2)
...
𝐴𝑙 and output transformation 𝐶 𝑙 are also constrained to be non-negative and bounded via a
...
ized: 𝑋ˆ 𝑙 = RMSNorm(vec( 𝑋𝑙 )) ∈ R1× 𝑛hc 𝑑 . Then, we follow the conventional HC to generate the
unconstrained raw parameters 𝐴˜ 𝑙 ∈ R1× 𝑛hc , 𝐵˜ 𝑙 ∈ R𝑛hc × 𝑛hc , and 𝐶˜𝑙 ∈ R𝑛hc ×1 :
                                               pre               pre          pre
                                       𝐴˜ 𝑙 = 𝛼𝑙     · ( 𝑋ˆ 𝑙 𝑊𝑙       ) + 𝑆𝑙 ,                             (3)
                                               res                      res          res
                                       𝐵˜ 𝑙 = 𝛼𝑙     · Mat( 𝑋ˆ 𝑙 𝑊𝑙 ) + 𝑆𝑙 ,                                (4)
                                               post                  post 𝑇         post
                                       𝐶˜𝑙 = 𝛼𝑙       · ( 𝑋ˆ 𝑙 𝑊𝑙       ) + 𝑆𝑙             ,                (5)
          pre   post                                             2
where 𝑊𝑙 , 𝑊𝑙 ∈ R𝑛hc 𝑑 × 𝑛hc and 𝑊𝑙res ∈ R𝑛hc 𝑑 × 𝑛hc are learnable parameters for generating the
dynamic components; Mat(·) reshapes a vector of size 1 × 𝑛2hc into a matrix of size 𝑛hc × 𝑛hc ;
 pre             post                                                                          pre   post
𝑆𝑙   ∈ R1× 𝑛hc , 𝑆𝑙 ∈ R𝑛hc ×1 , and 𝑆𝑙res ∈ R𝑛hc × 𝑛hc are learnable static biases; and 𝛼𝑙 , 𝛼res
                                                                                              𝑙
                                                                                                  , 𝛼𝑙      ∈R
...
Figure 3 | Core architectures of CSA. It compresses the number of KV entries to 𝑚1 times, and
...
𝐶 𝑎 , 𝐶 𝑏 ∈ R𝑛 × 𝑐 and their corresponding compression weights 𝑍 𝑎 , 𝑍 𝑏 ∈ R𝑛 × 𝑐 , where 𝑐 is the head
...
where 𝑊 𝑎𝐾𝑉 , 𝑊 𝑏𝐾𝑉 , 𝑊 𝑎𝑍 , 𝑊 𝑏𝑍 ∈ R𝑑 × 𝑐 are trainable parameters. Next, each 𝑚 KV entries in 𝐶 𝑎 and
𝐶 𝑏 will be compressed into one entry according to their compression weights and learnable
                                                                                          Comp
positional biases 𝐵𝑎 , 𝐵𝑏 ∈ R𝑚 × 𝑐 , producing 𝐶 Comp ∈ R 𝑚 × 𝑐 . Each compressed entry 𝐶 𝑖     ∈ R𝑐 is
                                                             𝑛


computed by
             𝑎                  𝑏                                    𝑎                 𝑎    𝑏                  𝑏
           [𝑆𝑚𝑖 :𝑚 ( 𝑖+1) −1 ; 𝑆𝑚 ( 𝑖 −1):𝑚𝑖 −1 ] = Softmaxrow ( [ 𝑍 𝑚𝑖:𝑚 ( 𝑖+1) −1 + 𝐵 ; 𝑍 𝑚 ( 𝑖 −1):𝑚𝑖 −1 + 𝐵 ]),          (11)
                                                      𝑚 ( 𝑖∑︁
                                                           +1) −1                      𝑚𝑖 −1
                                       Comp
                                                                                       ∑︁
                                     𝐶𝑖           =                  𝑆 𝑎𝑗 ⊙ 𝐶 𝑎𝑗 +                 𝑆𝑏𝑗 ⊙ 𝐶 𝑏𝑗 ,              (12)
                                                         𝑗=𝑚𝑖                        𝑗=𝑚 ( 𝑖 −1)
...
𝑍 𝑎 and 𝑍 𝑏 . When 𝑖 = 0, 𝑍 𝑚
                            𝑏
                              ( 𝑖 −1):𝑚𝑖 −1
                                            is padded with negative infinity and 𝐶𝑚
                                                                                  𝑏
                                                                                    ( 𝑖 −1):𝑚𝑖 −1
                                                                                                  is padded
                                     Comp
with zeros. Note that each 𝐶 𝑖                is derived from 2𝑚 KV entries, but the indexes of 𝐶 𝑏 used for
 Comp                                                   Comp
𝐶𝑖     and the indexes of 𝐶 𝑎 used for 𝐶 𝑖 −1                    are overlapped. Therefore, CSA in fact compresses
the sequence length to 𝑚1 times.
...
𝐾 IComp ∈ R 𝑚 × 𝑐 , where 𝑐 𝐼 is the indexer head dimension. Then, for a query token 𝑡 , we produce
            𝑛    𝐼


the indexer queries {q𝑡𝐼,1 ; q𝑡𝐼,2 ; ...; q𝑡𝐼,𝑛𝐼 } in a low-rank manner:
                                                  ℎ


                                                                               c𝑡𝑄 = h𝑡 · 𝑊 𝐷𝑄 ,                             (13)
                                          [q𝑡𝐼,1 ; q𝑡𝐼,2 ; ...; q𝑡𝐼,𝑛𝐼 ] = q𝑡𝐼 = c𝑡𝑄 · 𝑊 𝐼𝑈𝑄 ,                               (14)
                                                                      ℎ


where h𝑡 ∈ R𝑑 is the input hidden state of the query token 𝑡 ; c𝑡𝑄 ∈ R𝑑𝑐 is the compressed
latent vector for queries; 𝑑 𝑐 denotes the query compression dimension; 𝑛ℎ𝐼 denotes the number
of indexer query heads; 𝑊 𝐷𝑄 ∈ R𝑑 × 𝑑𝑐 and 𝑊 𝐼𝑈𝑄 ∈ R𝑑𝑐 × 𝑐 𝑛ℎ are the down-projection and up-
                                                           𝐼 𝐼


projection matrices for indexer queries, respectively. Next, the index score 𝐼𝑡,𝑠 ∈ R between the
query token 𝑡 and a preceding compressed block 𝑠 (𝑠 < Floor( 𝑚𝑡 )) is computed by

                         [ 𝑤𝑡𝐼,1 ; 𝑤𝑡𝐼,2 ; ...; 𝑤𝑡𝐼,𝑛𝐼 ] = w𝑡𝐼 = h𝑡 · 𝑊 𝑤 ,                                                  (15)
                                                  ℎ
                                                                          𝐼
                                                                      𝑛ℎ                                            
                                                                                                             IComp
                                                                      ∑︁
                                                           𝐼 𝑡 ,𝑠 =           𝑤𝑡𝐼,ℎ · ReLU q𝑡𝐼,ℎ · 𝐾𝑠                    ,   (16)
                                                                      ℎ=1


where 𝑊 𝑤 ∈ R𝑑 × 𝑛ℎ is a learnable matrix; 𝑤𝑡𝐼,ℎ ∈ R is the weight of the ℎ-th indexer head. For a
                     𝐼


query token 𝑡 , given its index scores 𝐼𝑡,: , we employ a top-k selector to selectively retain a subset
                              SprsComp
of compressed KV entries C𝑡            for subsequent core attention:
                                               n                          o
                                SprsComp         Comp
                               C𝑡           = 𝐶𝑠      𝐼𝑡,𝑠 ∈ Top-k( 𝐼𝑡,: ) .                       (17)
...
attention in a Multi-Query Attention (MQA) (Shazeer, 2019) manner, where each compressed
               SprsComp
KV entry in C𝑡          serves as both attention key and value. To be specific, for a query token 𝑡 ,
we first produce attention queries {q𝑡,1 ; q𝑡,2 ; ...; q𝑡,𝑛ℎ } from the compressed latent vector c𝑡𝑄 :

                                      [q𝑡,1 ; q𝑡,2 ; ...; q𝑡,𝑛ℎ ] = q𝑡 = c𝑡𝑄 · 𝑊 𝑈𝑄 ,                        (18)

where 𝑛ℎ denotes the number of query heads; 𝑊 𝑈𝑄 ∈ R𝑑𝑐 × 𝑐𝑛ℎ is the up-projection matrices for
queries. Note that the latent query vector c𝑡𝑄 is shared with that used for the indexer queries.
                                       SprsComp
Next, we perform MQA on {q𝑡,𝑖 } and C𝑡           :
                                                                              
                                                    SprsComp          SprsComp
               o𝑡,𝑖 = CoreAttn query=q𝑡,𝑖 , key=C𝑡           , value=C𝑡          ,         (19)
...
cost, we design a grouped output projection strategy. To be specific, we first split 𝑛ℎ outputs
                                                                                𝑛ℎ
into 𝑔 groups, and then for each group of output o𝐺𝑡,𝑖 ∈ R𝑐 𝑔 , we project it to a 𝑑 𝑔 -dimensional
                                       ′
intermediate output o𝐺𝑡,𝑖 ∈ R𝑑𝑔 , where 𝑑 𝑔 < 𝑐 𝑛𝑔ℎ . Finally, we project the intermediate output
     ′       ′            ′
[o𝐺𝑡,1 ; o𝐺𝑡,2 ; ...; o𝐺𝑡,𝑔 ] ∈ R𝑑𝑔 𝑔 to the final attention output ô𝑡 ∈ R𝑑 .
...
into one according to the compression weights and learnable positional biases 𝐵 ∈ R𝑚 × 𝑐 ,
                                                        Comp
producing 𝐶 Comp ∈ R 𝑚′ × 𝑐 . Each compressed entry 𝐶 𝑖       ∈ R𝑐 is computed by
                          𝑛




                           𝑆𝑚′ 𝑖:𝑚′ ( 𝑖+1) −1 = Softmaxrow ( 𝑍 𝑚′ 𝑖:𝑚′ ( 𝑖+1) −1 + 𝐵),            (22)
                                               𝑚′ ( 𝑖+1) −1
                                    Comp
                                                  ∑︁
                                  𝐶𝑖       =                  𝑆 𝑗 ⊙ 𝐶 𝑗.                          (23)
...
Through this compression operation, HCA compresses the sequence length to 𝑚1′ times.
...
query token 𝑡 , HCA first produces attention queries {q𝑡,1 ; q𝑡,2 ; ...; q𝑡,𝑛ℎ } in a low-rank manner:
                                                                 ...
                                                                 c𝑡𝑄 = h𝑡 · 𝑊 𝐷𝑄 ,                (24)
                                  [q𝑡,1 ; q𝑡,2 ; ...; q𝑡,𝑛ℎ ] = q𝑡 = c𝑡𝑄 · 𝑊 𝑈𝑄 ,                 (25)

where h𝑡 ∈ R𝑑 is the input hidden state of the query token 𝑡 ; 𝑛ℎ denotes the number of query
heads; 𝑊 𝐷𝑄 ∈ R𝑑 × 𝑑𝑐 and 𝑊 𝑈𝑄 ∈ R𝑑𝑐 × 𝑐𝑛ℎ are the down-projection and up-projection matrices for
queries, respectively. Next, we perform MQA on {q𝑡,𝑖 } and 𝐶 Comp :
                                                                          
                     o𝑡,𝑖 = CoreAttn query=q𝑡,𝑖 , key=𝐶 Comp , value=𝐶 Comp ,                (26)

where o𝑡,𝑖 ∈ R𝑐 is the core attention output of the 𝑖-th head at the 𝑡 -th token. Next, as CSA does,
                                                                                         𝑛ℎ
HCA splits 𝑛ℎ outputs into 𝑔 groups, and for each group of output o𝐺𝑡,𝑖 ∈ R𝑐 𝑔 , HCA projects it
                                                          ′
to a 𝑑 𝑔 -dimensional intermediate output o𝐺𝑡,𝑖 ∈ R𝑑𝑔 , where 𝑑 𝑔 < 𝑐 𝑛𝑔ℎ . Finally, HCA projects the
                          ′      ′            ′
intermediate output [o𝐺𝑡,1 ; o𝐺𝑡,2 ; ...; o𝐺𝑡,𝑔 ] ∈ R𝑑𝑔 𝑔 to the final attention output ô𝑡 ∈ R𝑑 .
...
{ 𝑧1′ , 𝑧2′ , ..., 𝑧𝑛′ ℎ }. For the ℎ-th attention head, Exp( 𝑧ℎ′ ) will be added to the denominator of the
attention score:
                                                              Exp( 𝑧ℎ,𝑖, 𝑗 )
                                             𝑠ℎ,𝑖, 𝑗 = Í                           ′ ,                  (27)
                                                         𝑘 Exp( 𝑧 ℎ,𝑖,𝑘 ) + Exp( 𝑧 ℎ )
...
Require: Learning rate 𝜂, momentum 𝜇 , weight decay 𝜆 , update rescaling factor 𝛾
 ...
 3:         𝐺𝑡 = ∇𝑊 L𝑡 (𝑊𝑡 −1 )                                          ⊲ Compute gradients
 4:         𝑀𝑡 = 𝜇𝑀𝑡 −1 + 𝐺𝑡                                 ⊲ Accumulate momentum buffer
 5:         𝑂𝑡′ = HybridNewtonSchulz( 𝜇𝑀𝑡 + 𝐺𝑡 ) ⊲ Nesterov trick and hybrid Newton-Schulz
                      √︁
 6:         𝑂𝑡 = 𝑂𝑡′ · max( 𝑛, 𝑚) · 𝛾                               ⊲ Rescale the update RMS
...
(SVD) be 𝑀 = 𝑈Σ𝑉 𝑇 . The Newton-Schulz iterations aim to approximately orthogonalize 𝑀 to be
𝑈𝑉 𝑇 . Usually, 𝑀 will be first normalized as 𝑀0 = 𝑀 /|| 𝑀 || 𝐹 to ensure its maximum singular value
does not exceed 1. Then, each Newton-Schulz iteration performs the following operation:

                        𝑀𝑘 = 𝑎𝑀𝑘 −1 + 𝑏 ( 𝑀𝑘 −1 𝑀𝑘𝑇−1 ) 𝑀𝑘 −1 + 𝑐 ( 𝑀𝑘 −1 𝑀𝑘𝑇−1 ) 2 𝑀𝑘 −1 .            (28)
...
challenges are listed as follows:
   ...
   3 https://docs.nvidia.com/deeplearning/performance/dl-performance-matrix-multiplicat
...
typically less than 𝑚𝑠 and vary across ranks. On the other hand, the compression requires 𝑚
...
compresses some of these received entries together with its local 𝑠 uncompressed KV entries,
                                               ...
                                               20
producing a fixed length of 𝑚𝑠 + 1 compressed entries, in which exist some padding entries. In
...
KV entries with a total length of cp_size · 𝑚𝑠 . Any padding entries are placed at the tail. For
...
                    State Cache                                      KV Cache
    ...
    Request 1   SWA KV                                     Block 0
                              KV State                                HCA KV
                           Uncompressed                               CSA KV
                                                                     Layer-2    CSA Indexer KV             CSA Main KV
    Request 2   SWA KV                                     Block 1
                              KV State                                HCA KV      of k1 tokens              of k1 tokens
                            Uncompressed                             Layer-3                 HCA KV of k2 tokens
                                                                      CSA KV
    Request 3   SWALayer-0
                    KV     SWA KV      Layer-2 CSA State   Block 2
                              KV State                                HCA KV
                                                                     Layer-4    CSA Indexer KV             CSA Main KV
                                                                                  of k1 tokens              of k1 tokens
                SWA KV   …UncompressedLayer-3 HCA State               CSA KV
         ……
                                                              ...
                                                              ……
                             KV State                                Layer-5                 HCA KV of k2 tokens
                                                                      HCA KV
                   Layer-n SWA KV             …                       ...                            ...
...
that are not yet ready for compression. In the classical KV cache, we allocate multiple blocks
                                                                                          ′
per request. Each cache block covers lcm( 𝑚, 𝑚′ ) original tokens, producing 𝑘1 = lcm(𝑚𝑚,𝑚 ) CSA
                                      ′
compressed tokens and 𝑘2 = lcm(𝑚𝑚′,𝑚 ) HCA compressed tokens.
...
of 𝑚1 and 𝑚1′ , respectively, thereby decreasing the overall KV cache size. As a result, KV cache
...
𝑚 to 4, the number of indexer query heads 𝑛ℎ𝐼 to 64, the indexer head dimension 𝑐 𝐼 to 128, and
...
heads 𝑛ℎ to 64, the head dimension 𝑐 to 512, and the query compression dimension 𝑑 𝑐 to 1024.
The number of output projection groups 𝑔 is set to 8, and the dimension of each intermediate
attention output 𝑑 𝑔 is set to 1024. For the additional branch of sliding window attention, the
...
indexer query heads 𝑛ℎ𝐼 to 64, the indexer head dimension 𝑐 𝐼 to 128, and the number of KV entries
...
dimension 𝑐 to 512, and the query compression dimension 𝑑 𝑐 to 1536. The number of output
projection groups 𝑔 is set to 16, and the dimension of each intermediate attention output 𝑑 𝑔 is set
...
Table 2 | Comparison of three reasoning modes
     ...
     Non-think         Fast, intuitive re- Routine daily tasks, </think> summary
                       sponses based on emergency reactions,
                       habits or simple low-risk decisions.
                       rules.
     Think High        Conscious logical       Complex problem- <think> thinking
                       analysis, slower but    solving, planning, tokens </think>
                       more accurate.          medium-risk deci- summary
                                               sions.
...
set of 𝑁 expert models {𝜋𝐸1 , 𝜋𝐸2 , . . . , 𝜋𝐸 𝑁 }, the OPD objective function is defined as:
                                               𝑁
                                              ∑︁                      
                                LOPD ( 𝜃) =         𝑤𝑖 · DKL 𝜋𝜃 ∥ 𝜋 𝐸𝑖 .                      (29)
                                              𝑖=1

In this formulation, 𝑤𝑖 represents the assigned weight for each expert, typically determined
                                                                                            by
the relative importance of the expert. Computing the reverse KL loss DKL 𝜋𝜃 ∥ 𝜋𝐸𝑖 requires
...
loss into a token-level KL estimate at each token position, and reuse RL framework by replac-
            𝜋 𝐸 ( 𝑦𝑡 | 𝑥 , 𝑦<𝑡 ) 
ing sg log 𝜋𝜃𝑖 ( 𝑦𝑡 | 𝑥 , 𝑦<𝑡 ) (sg represents the stop gradient operation) as the per-token advantage
...
CodeForces (Internal Benchmark), HMMT 2026 Feb, Apex (Balunović et al., 2025), Apex Short-
list (Balunović et al., 2025), IMOAnswerBench (Luong et al., 2025), and PutnamBench (Tsoukalas
et al., 2024).
...
retrieval performance remains highly stable within a 128K context window. While a performance
                                                                   ...
                                                                   39
                         Practical Regime                                                   Frontier Regime
    Putnam-200 Pass@8 with minimal tools                                 Putnam-2025 with hybrid formal-informal
          and bounded sampling.                                          reasoning and substantial compute scaling.
...
                                          HLE                                                   TerminalBench 2.0
    ...
    Pass@1 (%)
                 ...
                 10                         DeepSeek-V4-Flash                                               DeepSeek-V4-Flash
                      None                  DeepSeek-V3.2                          None                     DeepSeek-V3.2
                 5 None                                                       30
                  0     20k           40k        60k   80k                                20k      30k      40k     50k
...
outputs, only partial pages are displayed.
              ...
              Win Rate: DeepSeek-V4-Pro-Max vs Opus-4.6-Max                                                    Score: DeepSeek-V4-Pro-Max vs Opus-4.6-Max

  analysis                55.0%                    8.0%          37.0%                       100          98.32
                                                                                                                  96.68
                                                                                             95
...
generation            52.0%                   10.0%              38.0%
   ...
   editing           47.0%                    18.0%              35.0%
                                                                                             80                                                                     78.00
                                                                                                                                                                                  76.68
                                                                                             75
   overall             53.0%                   10.0%             37.0%                                                                                                                       72.68

                                                                                             70
         0%         20%            40%             60%           80%     100%                                on                      ing                     lity                     tics                 rall
                                                                                                       pleti                  Follo
                                                                                                                                    w                     Qua                    sthe                Ove
                                        Proportion                                                  Com               ction                        tent                   g Ae
                                                                                             Task                    u                       Con                     attin
                                                                                                               Instr                                        Form
                                  Win        Tie          Lose                                                                     DeepSeek-V4-Pro-Max                              Opus-4.6-Max




Figure 11 | Win-rate comparison across analy-                                        Figure 12 | Detailed dimension scores includ-
sis, generation, editing tasks, and the overall                                      ing Task Completion, Content Quality, Format-
performance.                                                                         ting Aesthetics, and Instruction Following.
...
Y. Bai, S. Tu, J. Zhang, H. Peng, X. Wang, X. Lv, S. Cao, J. Xu, L. Hou, Y. Dong, et al. Longbench
   ...
   (Volume 1: Long Papers), pages 3639–3664, 2025b.
                                                   ...
                                                   45
M. Balunović, J. Dekoninck, I. Petrov, N. Jovanović, and M. Vechev. Matharena: Evaluating llms
...
G. T. M. Riviere, S. Pathak, P. G. Sessa, C. Hardin, S. Bhupatiraju, L. Hussenot, T. Mesnard,
  ...
  C. L. Lan, S. Jerome, A. Tsitsulin, N. Vieillard, P. Stańczyk, S. Girgin, N. Momchev, M. Hoff-
...
Table 9 | Agentic Search vs. Retrieval Augmented Search for DeepSeek-V4-Pro.
 ...
 Difficulty Category                       #     Agent Win RAG Win Tie Agent% RAG% Tie%
             Objective Q&A (客观问答) 196               110             43       43        56.1       21.9      21.9
 Easy
             Subjective Q&A (主观问答) 321              198             56       67        61.7       17.4      20.9
             Objective Q&A (客观问答) 168               102             33       33        60.7       19.6      19.6
 Hard
...
Objective Single-value Search (单值信息查找)  95                          36           10   49   37.9      10.5     51.6
Q&A       Entity Search (实体信息查找)        99                          24            7   68   24.2       7.1     68.7
...
Subjective Advice Seeking (寻求建议)                         92         23            8   61   25.0       8.7     66.3
Q&A        Recommendation (推荐)                           95         26           19   50   27.4      20.0     52.6
...
Business Email & Letter (邮件书信)               146      107        37    2   73.29   25.34   1.37
...
Media   News Report (新闻报道)                    51       27        22    2   52.94   43.14 3.92
...
Everyday Communication   (沟通回复)              100       71        26   3    71.00   26.00   3.00
Writing  Reflection (心得感想)                    90       68        17   5    75.56   18.89   5.56
...
Oral
Writing Sales Script (话术)                     31       22         6   3 70.97      19.35   9.68
...
Official
Document Government Doc (行政公文)                34       19        14   1    55.88   41.18 2.94
...
Writing  Academic Support (学术辅助)              15       11         3   1    73.33   20.00   6.67
(学术文本) Science Outreach (专业科普)                 7        6         1   0    85.71   14.29   0.00
